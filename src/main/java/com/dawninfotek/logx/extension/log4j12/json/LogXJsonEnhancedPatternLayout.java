 ...
 *
  ...
  * </p>
   ...
   @since 1.2.16 */
public class LogXJsonEnhancedPatternLayout extends Layout {
  ...
  */
  public LogXJsonEnhancedPatternLayout() {
  ...
  */
  public LogXJsonEnhancedPatternLayout(final String pattern) {
    this.conversionPattern = pattern;
    head = createPatternParser(
            (pattern == null) ? DEFAULT_CONVERSION_PATTERN : pattern).parse();
    if (head instanceof LogXJsonBridgePatternConverter) {
        handlesExceptions = !((LogXJsonBridgePatternConverter) head).ignoresThrowable();
    } else {
  ...
  public String getConversionPattern() {
    ...
    */
    protected org.apache.log4j.helpers.PatternParser createPatternParser(String pattern) {
      return new LogXJsonBridgePatternParser(pattern);
    }
