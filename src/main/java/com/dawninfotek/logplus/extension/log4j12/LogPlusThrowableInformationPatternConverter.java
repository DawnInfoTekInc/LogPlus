...
public class LogPlusThrowableInformationPatternConverter extends LoggingEventPatternConverter {
	   ...
	   */
	  private LogPlusThrowableInformationPatternConverter(
	   ...
	   */
	  public static LogPlusThrowableInformationPatternConverter newInstance(
	    final String[] options) {
	    return new LogPlusThrowableInformationPatternConverter(options);
	  }
