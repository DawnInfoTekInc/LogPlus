 ...
 *
  ...
  * </p>
   ...
   @since 1.2.16 */
public class LogPlusEnhancedPatternLayout extends Layout {
  ...
  */
  public LogPlusEnhancedPatternLayout() {
  ...
  */
  public LogPlusEnhancedPatternLayout(final String pattern) {
    this.conversionPattern = pattern;
    head = createPatternParser(
            (pattern == null) ? DEFAULT_CONVERSION_PATTERN : pattern).parse();
    if (head instanceof LogPlusBridgePatternConverter) {
        handlesExceptions = !((LogPlusBridgePatternConverter) head).ignoresThrowable();
    } else {
  ...
  public String getConversionPattern() {
    ...
    */
    protected org.apache.log4j.helpers.PatternParser createPatternParser(String pattern) {
      return new LogPlusBridgePatternParser(pattern);
    }
