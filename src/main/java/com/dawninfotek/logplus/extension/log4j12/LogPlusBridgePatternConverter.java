...
public class LogPlusBridgePatternConverter extends org.apache.log4j.helpers.PatternConverter {
	/**
	 * Pattern converters.
	 */
	 ...
	 */
	public LogPlusBridgePatternConverter(final String pattern) {
		next = null;
		...
		converterRegistry.put("throwable", LogPlusThrowableInformationPatternConverter.class);
		converterRegistry.put("m", LogPlusMessagePatternConverter.class);
		converterRegistry.put("message", LogPlusMessagePatternConverter.class);
