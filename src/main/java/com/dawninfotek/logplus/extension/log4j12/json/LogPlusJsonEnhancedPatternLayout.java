 ...
 *
  ...
  * </p>
   ...
   @since 1.2.16 */
public class LogPlusJsonEnhancedPatternLayout extends Layout {
  ...
  */
  public LogPlusJsonEnhancedPatternLayout() {
  ...
  */
  public LogPlusJsonEnhancedPatternLayout(final String pattern) {
    this.conversionPattern = pattern;
    head = createPatternParser(
            (pattern == null) ? DEFAULT_CONVERSION_PATTERN : pattern).parse();
    if (head instanceof LogPlusJsonBridgePatternConverter) {
        handlesExceptions = !((LogPlusJsonBridgePatternConverter) head).ignoresThrowable();
    } else {
  ...
  public String getConversionPattern() {
    ...
    */
    protected org.apache.log4j.helpers.PatternParser createPatternParser(String pattern) {
      return new LogPlusJsonBridgePatternParser(pattern);
    }
